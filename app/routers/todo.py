...
@todo_router.get("/todoss/{id}")
def get_todo_by_id(db:SessionDep, user:AuthDep, id:int):
...
def cretate_todo(db:SessionDep, user: AuthDep, todo_data: TodoCreate):
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail="An error occured while creating an item",
        )
